...
class Seller(models.Model):
    ...
    address = models.CharField(max_length=32,verbose_name="收货地址",null=True,blank=True)
...
class Store(models.Model):
    ...
    store_id = models.IntegerField(verbose_name="店铺主人")
...
class Goods(models.Model):
    ...
    goods_date = models.DateField(verbose_name="出场时间")
